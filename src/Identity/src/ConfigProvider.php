...
readonly class ConfigProvider
{
    ...
    {
        return [
            Infrastructure\Hydrator\AccountActivationHydrator::class => [
            ...
            Infrastructure\Persistence\Repository\AccountAccessAuthRepository::class => [
                AccountAccessAuthStoreInterface::class,
            ],
            Infrastructure\Persistence\Repository\AccountActivationRepository::class => [
            ...
            Infrastructure\Persistence\Table\AccountAccessAuthTable::class => [
                Query::class,
                AccountAccessAuthHydratorInterface::class,
            ],
            Infrastructure\Persistence\Table\AccountActivationTable::class => [
                Query::class,
